 ...
 */
final class Version20210407070648 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE product_system_attribute ADD create_time DATETIME NOT NULL, ADD last_update DATETIME NOT NULL');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE product_system_attribute DROP create_time, DROP last_update');
    }
}
